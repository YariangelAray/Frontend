...
addEventListener('DOMContentLoaded', async () => {
  ...
  // Recorremos la lista de lenguajes y creamos una fila por cada lenguaje
  lenguajes.forEach((lenguaje) => {
    ...
    // Agregamos un evento al hacer click en la fila para redirigir a la página de gestión de lenguaje
    fila.addEventListener('click', () => {
      window.location.href = `../../Lenguaje/lenguajeGestion.html?id=${lenguaje.id}`;
    });
  });
